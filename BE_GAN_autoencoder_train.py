...
def Generator_Net():
    ...
    GN_conv_10 = UpSampling2D(size=(2,2))(GN_conv_10)
    ...
    GN_conv_12 = UpSampling2D(size=(2,2))(GN_conv_12)
    ...
    GN_conv_14 = UpSampling2D(size=(2,2))(GN_conv_14)
    
    GN_outputs = Conv2D(3, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(GN_conv_14)
...
def Discriminator_Net():
    ...
    DN_conv_10 = UpSampling2D(size=(2,2))(DN_conv_10)
    ...
    DN_conv_12 = UpSampling2D(size=(2,2))(DN_conv_12)
    ...
    DN_conv_14 = UpSampling2D(size=(2,2))(DN_conv_14)
    
    DN_outputs = Conv2D(3, (3, 3), padding='same', kernel_regularizer=l2(weight_decay))(DN_conv_14)
